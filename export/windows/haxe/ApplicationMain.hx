...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlixelGame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlixelGame", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FlixelGame";
		app.meta["name"] = "FlixelGame";
